...
// ----------- STEPS DATA same as DSTV -------------
const steps = [
  {
    icon: icons.cart,
    title: '1. Choose Plan',
    desc: 'Select your preferred Netflix package above.'
  },
  {
    icon: icons.chat,
    title: '2. Fill Details',
    desc: 'Enter your Netflix login/contact, then proceed.'
  },
  {
    icon: icons.party,
    title: '3. Enjoy Streaming',
    desc: "Your Netflix access is set up in minutes!"
  }
];

// ----------- NETFLIX PACKAGE DATA ----------
const packageData = [
  ...
  packageData.forEach(pkg => {
    ...
    card.innerHTML = `
      <div class="w-full flex flex-col items-center mb-3">
        <span class="text-2xl font-extrabold text-blue-400 mb-1">${pkg.newPrice}</span>
